---
title: "Initial Linear Model Exploration"
...
Test linear models to predict internalizing symptoms (CBCL & BPM) using demographics, SES latent factors, and MRI features. Includes data preprocessing, stratified splitting, and R² visualizations for parent and child reports.
